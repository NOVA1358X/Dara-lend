...
export const DP_BTC_PROGRAM_ID = 'dara_dp_btc_v2.aleo';
export const DP_ETH_PROGRAM_ID = 'dara_dp_eth_v2.aleo';
export const DP_SOL_PROGRAM_ID = 'dara_dp_sol_v2.aleo';

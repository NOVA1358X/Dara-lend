...
const typeLabels: Record<string, string> = {
  supply_collateral: 'Supply ALEO',
  supply_usdcx_collateral: 'Supply USDCx',
  supply_usad_collateral: 'Supply USAD',
  borrow: 'Borrow USDCx',
  borrow_usad: 'Borrow USAD',
  borrow_credits: 'Borrow ALEO',
  repay: 'Repay USDCx Debt',
  repay_usad: 'Repay USAD Debt',
  repay_credits_usdcx: 'Repay ALEO (USDCx col)',
  repay_credits_usad: 'Repay ALEO (USAD col)',
  withdraw_collateral: 'Withdraw ALEO',
  withdraw_usdcx_collateral: 'Withdraw USDCx',
  withdraw_usad_collateral: 'Withdraw USAD',
  liquidate: 'Liquidate ALEO',
  liquidate_usdcx: 'Liquidate USDCx',
  liquidate_usad: 'Liquidate USAD',
  update_oracle_price: 'Oracle Update',
  set_rate_params: 'Set Rate Params',

...
const advantages = [
  { title: '14 Production Smart Contracts', desc: 'Lending, credits, vault, governance, 4 dark pool markets, 3 test tokens, auctions, and flash loans — 149 transitions deployed on Aleo with ~10M compiled variables.', icon: 'architecture' },
  { title: 'Real-Time Oracle (7 Sources)', desc: 'Prices from Coinbase, Binance, MEXC, XT.com, CoinGecko, CMC, and CryptoCompare — cross-checked, outlier-rejected, pushed on-chain every 30 minutes.', icon: 'monitoring' },
  { title: 'Anti-MEV by Design', desc: 'Sealed-bid auctions with BHP256 commitments, 4-market dark pool with batch TWAP settlement and 2-of-3 threshold operators — front-running is mathematically impossible.', icon: 'enhanced_encryption' },
